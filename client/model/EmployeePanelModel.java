...
public class EmployeePanelModel {
	...
	public void setArrayOfClients(edu.model.Employee employee) throws ClassNotFoundException, SQLException {
		
		System.out.println(employee.getAllClients(true,1).get(1).getLastName());
		
		ArrayList<edu.model.Client> arrayClient = employee.getAllClients(true,1);
